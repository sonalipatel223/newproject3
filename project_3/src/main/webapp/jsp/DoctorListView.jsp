...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.DOCTOR_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Doctor List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="mobile" placeholder="Enter mobile"
						class="form-control" oninput="validateMobileNo(event)"  name="mobile"
						maxlength="10"
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("expertise", String.valueOf(dto.getExpertise()), map)%></div>
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=DoctorListCtl.OP_BACK%>">
		</div>
