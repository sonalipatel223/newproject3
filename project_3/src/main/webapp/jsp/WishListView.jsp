...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.WISH_LIST_CTL%>" method="post">
			...
			<%
				...
				Iterator<WishDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Wish List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<input type="submit" class="btn btn-primary btn-md"
					...
					value="<%=WishListCtl.OP_SEARCH%>"> &emsp; <input
					type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
					name="operation" value="<%=WishListCtl.OP_RESET%>">
			</div>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bWished table-dark table-hover">
			<thead>
			...
			<tbody>
				<tr>
					...
					<td class="text"><a href="WishCtl?id=<%=dto.getId()%>">Edit</a></td>
				</tr>
			</tbody>
			<%
				}
	...
	<table width="100%">
		<tr>
			...
			<td align="right"><input type="submit" name="operation"
				class="btn btn-warning btn-md" style="font-size: 17px"
				style="padding: 5px;" value="<%=WishListCtl.OP_NEXT%>"
	...
	%>
	<center>
		<h1 style="font-size: 40px; color: #162390;">Wish List</h1>
	</center>
	</br>
	<div class="row">
		<div class="col-md-4"></div>
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=WishListCtl.OP_BACK%>">
		</div>
