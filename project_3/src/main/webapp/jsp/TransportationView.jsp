...
<style type="text/css">
i.css {
	bTransportation: 2px solid #8080803b;
	padding-left: 10px;
	padding-bottom: 11px;
...
<body class="hm">
	...
	<div>
		...
		<form action="<%=ORSView.TRANSPORTATION_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.TransportationDTO"
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Transportation</h3>
							<%
								}
							%>
							...
							<div>
								<%
									HashMap map = (HashMap) request.getAttribute("modep");
								%>
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											...
											onblur="validateLetterInput(this, 'descriptionError', 200)"></textarea>
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList("mode", String.valueOf(dto.getMode()), map)%>
									</div>
								</div>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=TransportationCtl.OP_UPDATE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=TransportationCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=TransportationCtl.OP_SAVE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=TransportationCtl.OP_RESET%>">
								</div>
