			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="amount" placeholder="Enter amount"
						class="form-control" id="number" onkeydown="validateKey(event)"
						value="<%=ServletUtility.getParameter("amount", request)%>">


					<span id="validation-message">Please enter only numbers.</span>
				</div>
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=OrderListCtl.OP_BACK%>">
		</div>
