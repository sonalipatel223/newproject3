...
<style type="text/css">
i.css {
	bVehicleTracking: 2px solid #8080803b;
	padding-left: 10px;
	padding-bottom: 11px;
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add VehicleTracking</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								<span class="pl-sm-5"><b> Lat</b> <span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="number" class="form-control" name="lat"
											placeholder="Enter lat"  oninput="numberLength(this)"  step="any" maxlength="10"
											value="<%=DataUtility.getDoublee(dto.getLat())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("lat", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="number" class="form-control" name="longitude"
											placeholder=" Enter longitude"  oninput="numberLength(this)"  step="any" maxlength="10"
											value="<%=DataUtility.getDoublee(dto.getLongitude())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("longitude", request)%></font></br>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=VehicleTrackingCtl.OP_UPDATE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=VehicleTrackingCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=VehicleTrackingCtl.OP_SAVE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=VehicleTrackingCtl.OP_RESET%>">
								</div>
