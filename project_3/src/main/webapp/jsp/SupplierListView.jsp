...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.SUPPLIER_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Supplier List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="number" name=paymentTerm placeholder="Enter paymentTerm"
						class="form-control"  name="paymentTerm"  oninput="numberLength(this)" 
						maxlength="10"
				...
				<div class="col-sm-2">
					<input type="text" name="registrationDate" placeholder="Enter registrationDate"
	...
	<table width="100%">
		<tr>
			...
			<td align="right"><input type="submit" name="operation"
				class="btn btn-warning btn-md" style="font-size: 17px"
				style="padding: 5px;" value="<%=SupplierListCtl.OP_NEXT%>"
	...
	%>
	<center>
		<h1 style="font-size: 40px; color: #162390;">Supplier List</h1>
	</center>
	</br>
	<div class="row">
		<div class="col-md-4"></div>
