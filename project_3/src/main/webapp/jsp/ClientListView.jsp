...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.CLIENT_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Client List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("priority", String.valueOf(dto.getPriority()), map)%></div>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bCliented table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">Phone</th>

					<th width="15%" class="text">Priority</th>
			...
			<tbody>
				<tr>
					...
					<td class="number"><%=dto.getPhone()%></td>
	...
	<table width="100%">
		<tr>
			...
			<td align="right"><input type="submit" name="operation"
				class="btn btn-warning btn-md" style="font-size: 17px"
				style="padding: 5px;" value="<%=ClientListCtl.OP_NEXT%>"
	...
	%>
	<center>
		<h1 style="font-size: 40px; color: #162390;">Client List</h1>
	</center>
	</br>
	<div class="row">
		<div class="col-md-4"></div>
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=ClientListCtl.OP_BACK%>">
		</div>
