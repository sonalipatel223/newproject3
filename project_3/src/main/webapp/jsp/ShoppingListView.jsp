...
<%@page import="in.co.rays.project_3.dto.ShoppingDTO"%>
<%@page import="in.co.rays.project_3.controller.ShoppingListCtl"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.SHOPPING_LIST_CTL%>"
			method="post">
			...
			<%
				...
				Iterator<ShoppingDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("product", String.valueOf(dto.getProduct()), map)%></div>
					...
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=ShoppingListCtl.OP_SEARCH%>"> &emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=ShoppingListCtl.OP_RESET%>">
				</div>
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-bShoppinged table-dark table-hover">
					<thead>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="ShoppingCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ShoppingListCtl.OP_PREVIOUS%>"
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ShoppingListCtl.OP_NEXT%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Shopping List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
