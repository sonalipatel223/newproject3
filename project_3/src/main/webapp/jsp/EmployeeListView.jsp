	...
	<div>
		<form class="pb-5" action="<%=ORSView.EMPLOYEE_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="dateOfJoining" placeholder="Enter DateOfJoining"
						class="form-control"
						value="<%=ServletUtility.getParameter("dateOfJoining", request)%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">Department</th>
							<th width="15%" class="text">DateOfJoining</th>
							<th width="15%" class="text">LastEmployeeName</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getDepartment()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getDateOfJoining())%></td>
							<td class="text"><%=dto.getLastEmployeeName()%></td>
							
							

							<td class="text"><a href="EmployeeCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
