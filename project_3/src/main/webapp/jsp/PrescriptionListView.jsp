...
<%@page import="in.co.rays.project_3.dto.PrescriptionDTO"%>
<%@page import="in.co.rays.project_3.controller.PrescriptionListCtl"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PRESCRIPTION_LIST_CTL%>" method="post">
			...
			<%
				...
				Iterator<PrescriptionDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Prescription List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="capacity" placeholder="Enter Capacity"
						class="form-control"
						value="<%=ServletUtility.getParameter("capacity", request)%>">
				</div>
				...
				<input type="submit" class="btn btn-primary btn-md"
					...
					value="<%=PrescriptionListCtl.OP_SEARCH%>"> &emsp; <input
					type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
					name="operation" value="<%=PrescriptionListCtl.OP_RESET%>">
			</div>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bPrescriptioned table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">Capacity</th>
			...
			<tbody>
				<tr>
					...
					<td class="text"><a href="PrescriptionCtl?id=<%=dto.getId()%>">Edit</a></td>
				</tr>
			</tbody>
			<%
				}
	...
	<table width="100%">
		<tr>
			...
			<td align="right"><input type="submit" name="operation"
				class="btn btn-warning btn-md" style="font-size: 17px"
				style="padding: 5px;" value="<%=PrescriptionListCtl.OP_NEXT%>"
	...
	%>
	<center>
		<h1 style="font-size: 40px; color: #162390;">Prescription List</h1>
	</center>
	</br>
	<div class="row">
		<div class="col-md-4"></div>
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=PrescriptionListCtl.OP_BACK%>">
		</div>
