					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>LastEmployeeName</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control"
											name="lastEmployeeName" placeholder="LastEmployeeName"
											onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength="30"
											value="<%=DataUtility.getStringData(dto.getLastEmployeeName())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("lastEmployeeName", request)%></font></br>
