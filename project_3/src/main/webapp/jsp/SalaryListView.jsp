...
<body class="hm">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="appliedDate"
						placeholder="Enter appliedDate" class="form-control"
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bSalaryed table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">Employee</th>
			...
			<tbody>
				<tr>
					...
					<td class="text"><%=dto.getEmployee()%></td>
					<td class="number"><%=dto.getAmount()%></td>
					<td class="text"><%=dto.getStatus()%></td>
					
					<td class="text"><%=DataUtility.getDateString(dto.getAppliedDate())%></td>
