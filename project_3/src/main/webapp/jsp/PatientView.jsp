								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="name"
											...
											oninput="handleLetterInput(this, 'inputError', 20)"
											onblur="validateLetterInput(this, 'inputError', 20)"
											value="<%=DataUtility.getStringData(dto.getName())%>">
									</div>
								</div>

								<font color="red" class="pl-sm-5" id = "inputError"> <%=ServletUtility.getErrorMessage("name", request)%></font></br>
